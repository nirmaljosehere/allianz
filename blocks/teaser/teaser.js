...
export default function decorate(block) {
  ...
  // text-position variant: place text beside the image (left/right) instead of overlaid
  const textPosition = properties.textposition || 'overlay';
  if (textPosition === 'text-left' || textPosition === 'text-right') {
    block.classList.add('teaser-side', textPosition);
  }
